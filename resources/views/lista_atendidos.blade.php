...
<head>
    ...
    <link rel="stylesheet" href="/css/lista_atendidos.css">
</head>
<body>
    ...
    <div class="fundo">
        ...
        <div class="row">
            <h4 class="white-text">Lista de Utentes Atendidos e Cancelados</h4>
                ...
                <tbody>
                  @for ($i = 1; $i <= 5; $i++)
                    <tr>
                        ...
                        <td>10h:45m:30s</td>
                        <td>10h:45m:30s</td>
                        <td class="green white-text">Utente Atendido</td>
                        {{-- <td>
